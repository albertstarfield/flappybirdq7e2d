...
from e2dfunct import *
from e2dclass import *
import e2dvar as gameVariables
...
def main():
    ...
    gameImagesenvcoin= load_images_env_coin()
    ...
    while True:
        ...
        for l in gameCoin:
            ...
            if l.x <= - pipeWidth:
                ...
                screen.blit(gameImagesenvcoin['coin'], (l.x, l.toph2))
        ...
        draw_text(screen, "Flappybird q7e2d Demo", 30, 15)
