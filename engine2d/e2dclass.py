...
class Bird:
    ...
    def redraw(self, screen, image_1, image_2, image_3, image_4):
        if pygame.time.get_ticks() % 500 >= 250:
            ...
            screen.blit(image_4, (self.bird_x, self.bird_y))
...
class PipePair:
    ...
    def __init__(self, x, score_counted):
        ...
        self.toph2 = random.randint(100, 450) - pipeHeight
...
class Coins:
    ...
    def __init__(self, x, score_counted):
        self.x = gameWidth
        self.toph2 = random.randint(50, 450) - pipeHeight
        #self.bottomh2= self.toph + pipeHeight + pipesSpace
        self.score_counted = score_counted
